...
parser.add_argument('--exp_dir', type=str, default='.', help='the directory of experiment')
parser.add_argument('--input_path', type=str, default='.', help='real image path')
parser.add_argument('--output_path', type=str, default='.', help='test result output path')
